	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	Spring::Ref<Spring::VertexBuffer> vertexBuffer = Spring::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Spring::Ref<Spring::IndexBuffer> indexBuffer = Spring::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	Spring::Ref<Spring::VertexBuffer> squareVB = Spring::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{Spring::ShaderDataType::Float3, "a_Position"},
	...
	Spring::Ref<Spring::IndexBuffer> squareIB = Spring::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Spring::Timestep ts)
{
	// Update
	...
	for (int y = 0; y < 20; y++)
	{
		for (int x = 0; x < 20; x++)
		{
			...
			Spring::Renderer::Submit(m_FlatColorShader, m_SquareVA, transform);
		}
	}
...
void ExampleLayer::OnEvent(Spring::Event& e)
{
